...
hyperparameters = {"CAT": cat_params_ag}
...
test_pred_svr, oof_svr, score_svr = crossvalidate(
    "SVR",
    data_train[
        [
            "brand",
...
test_pred_lgb1, oof_lgb1, score_lgb1 = crossvalidate(
    "LGBM", data_train, data_test, n_bags, n_folds
)
...
model = LGBMRegressor(**lgb_params1)
test_pred_lgb1_st, oof_lgb1_st, score_lgb1_st = crossvalidate(
    "LGBM", data_train2, data_test2, n_bags, n_folds
)

data_concat, CAT_SIZE, CAT_EMB = label_encoding(pd.concat([data_train2, data_test2]), 5)
data_train2 = data_concat[: len(df_train)]
data_test2 = data_concat[len(df_train) :]

model = LGBMRegressor(**lgb_params5)
test_pred_lgb5_st, oof_lgb5_st, score_lgb5_st = crossvalidate(
    "LGBM", data_train2, data_test2, n_bags, n_folds
)
